        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            <motion.div 
              ...
              initial="hidden"
              animate="visible"
              className="space-y-0.5 mb-8"
            >
              <motion.h1 variants={itemVariants} className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter text-text-primary code-font">
                {t("hero.title_part1")}
              </motion.h1>
              <motion.h1 variants={itemVariants} className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter text-turquoise italic code-font">
                {t("hero.title_part2")}
              </motion.h1>
              <motion.h1 variants={itemVariants} className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter text-text-primary code-font">
                {t("hero.title_part3")}
          ...
          {/* RIGHT DASHBOARD (With Stats Floating Behind) */}
