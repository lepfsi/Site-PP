...
function HeroDashboard({
  ...
  return (
    <div className="relative aspect-square max-w-[380px] ml-auto w-full">
      ...
      <div className="absolute -top-10 -left-10 z-0 opacity-20 pointer-events-none hidden xl:block">
        <div className="space-y-4 font-mono text-[10px] text-turquoise">
      ...
      <div className="relative z-10 absolute inset-0 bg-bg-secondary/40 border border-white/5 backdrop-blur-3xl rounded-[1.5rem] shadow-2xl overflow-hidden flex flex-col h-full">
        {/* Mac Title Bar */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            >
              ...
              <a href="#articles" className="px-6 py-2.5 bg-bg-secondary border border-border-main text-text-secondary font-black rounded-xl flex items-center justify-center transition-all hover:bg-bg-primary text-[10px] tracking-widest uppercase">
                {t("hero.cta_browse")}
              </a>
              <a href="#newsletter" className="px-6 py-2.5 bg-bg-secondary border-2 border-transparent hover:border-turquoise text-text-secondary hover:text-turquoise font-bold rounded-xl flex items-center justify-center transition-all text-[10px] tracking-widest uppercase group">
